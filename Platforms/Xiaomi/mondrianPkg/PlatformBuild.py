# @file
# Script to Build Xiaomi Galaxy Tab S8 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("mondrianPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('mondrian', 'gcc_aarch64_linux', 'edk2-build')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager, ParseSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("mondrianPkg/mondrianNoSb.dsc", {})
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "mondrian", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "mondrianPkg/mondrian.dsc", "Platform Hardcoded")
